CRUD_documental = {};
DSON.keepmerge(CRUD_documental, CRUDDEFAULTS);
DSON.keepmerge(CRUD_documental, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_documental',
        //method: 'documental',
...
//CRUD_documental.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_documental.table.options[0].menus.push({
//     text: (data) => {
