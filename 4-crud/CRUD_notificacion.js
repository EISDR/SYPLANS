CRUD_notificacion = {};
DSON.keepmerge(CRUD_notificacion, CRUDDEFAULTS);
DSON.keepmerge(CRUD_notificacion, {
    table: {
        width: "width:1800px;",
        view: 'vw_notificacion',
        //method: 'notificacion',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
                ...
                menus: [
                    {
                        ...
                        show: function (data) {
                            if (notificacion.encargado_planificacion()){
                                return true;
                            }else return data.row.usuario === notificacion.session.usuario_id;
                        },
                        click: function (data) {
                    ...
                    },
                    {
                        ...
                        show: function (data) {
                            ...
                            } else return data.row.usuario === notificacion.session.usuario_id ? data.$scope.activeColumn() : false
                        }
                    },
                    {
                        text: (data) => {
...
//CRUD_notificacion.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_notificacion.table.options[0].menus.push({
//     text: (data) => {
