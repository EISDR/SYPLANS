CRUD_foda_items = {};
DSON.keepmerge(CRUD_foda_items, CRUDDEFAULTS);
DSON.keepmerge(CRUD_foda_items, {
    table: {
        engine: 'my',
        sortable: false,
        view: 'vw_foda_items',
                ...
                menus: [
                    ...
                    },
                    {
                        ...
                        click: function (data) {
                            ...
                            // foda_items.triggers.table.after.close = function (data) {
                            //     //console.log(`$scope.triggers.table.after.close ${$scope.modelName}`);
                            //     foda_items.columns().descripcion.shorttext = 370;
