...
lachechon = lachechon || {};
CRUD_solicitud_documento_actividades = {};
DSON.keepmerge(CRUD_solicitud_documento_actividades, CRUDDEFAULTS);
DSON.keepmerge(CRUD_solicitud_documento_actividades, {
    table: {
        //width: "width:3000px;",
        view: 'vw_solicitud_documento_actividades',
        //method: 'solicitud_documento_actividades',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
                ...
                menus: [
                    {
                        ...
                        click: function (data) {
                            ...
                            solicitud_documento_actividades.form.titles = {
                                edit: 'Editar Actividad: "'+ data.row.nombre  + '" de la Solicitud de Documento: "' + solicitud_documento.nombre + '"',
                            };
                            return false;
                        }
                    },
...
//CRUD_solicitud_documento_actividades.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_solicitud_documento_actividades.table.options[0].menus.push({
//     text: (data) => {
