CRUD_direcciones_area = {};
DSON.keepmerge(CRUD_direcciones_area, CRUDDEFAULTS);
DSON.keepmerge(CRUD_direcciones_area, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_direcciones_area',
        //method: 'direcciones_area',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
                    ...
                    },
                    {
                        ...
                        click: function (data) {
                            if (!DSON.oseaX(data.row)) {
                                direcciones_area.dataForView = data.row;
                                direcciones_area.modal.modalView(String.format("{0}/view", 'direcciones_area'), {
                                    header: {
                                        title: MESSAGE.i('mono.Viewof') + " Direcciones de área",
                                        icon: "user"
                                    },
                                    footer: {
                                        cancelButton: true
                                    ...
                                    content: {
                                        ...
                                        sameController: 'direcciones_area'
                                    },
                                });
                            }
                        }
...
//CRUD_direcciones_area.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_direcciones_area.table.options[0].menus.push({
//     text: (data) => {
