CRUD_proyecto_actividad = {};
DSON.keepmerge(CRUD_proyecto_actividad, CRUDDEFAULTS);
DSON.keepmerge(CRUD_proyecto_actividad, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_proyecto_actividad',
        //method: 'proyecto_actividad',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
        ...
        columns: {
            ...
            proyecto: {formattype: ENUM.FORMAT.numeric},
            nombre: {},
...
//CRUD_proyecto_actividad.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_proyecto_actividad.table.options[0].menus.push({
//     text: (data) => {
