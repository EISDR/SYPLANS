CRUD_procedimiento_seleccion = {};
DSON.keepmerge(CRUD_procedimiento_seleccion, CRUDDEFAULTS);
DSON.keepmerge(CRUD_procedimiento_seleccion, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_procedimiento_seleccion',
        //method: 'procedimiento_seleccion',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_procedimiento_seleccion.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_procedimiento_seleccion.table.options[0].menus.push({
//     text: (data) => {
