CRUD_documental_file = {};
DSON.keepmerge(CRUD_documental_file, CRUDDEFAULTS);
DSON.keepmerge(CRUD_documental_file, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_documental_file',
        //method: 'documental_file',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
        ...
        columns: {
            ...
            folder: {formattype: ENUM.FORMAT.numeric},
...
//CRUD_documental_file.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_documental_file.table.options[0].menus.push({
//     text: (data) => {
