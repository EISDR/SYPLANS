CRUD_asignacion_especial_poa = {};
DSON.keepmerge(CRUD_asignacion_especial_poa, CRUDDEFAULTS);
DSON.keepmerge(CRUD_asignacion_especial_poa, {
    table: {
        engine: 'my',
        width: 'width:1800px;',
        ...
        options: [
            {
                ...
                title: (data) => {
                    if (eval(`PERMISSIONS.mypermission.${data.$scope.modelName}`).allow.edit && eval(`PERMISSIONS.mypermission.${data.$scope.modelName}`).allow.view && eval(`PERMISSIONS.mypermission.${data.$scope.modelName}`).allow.remove && eval(`PERMISSIONS.mypermission.${data.$scope.modelName}`).allow.audit){
                        if (data.row.poa_estado != ENUM_2.poa_estatus.Cerrado && data.row.estatus_id == ENUM_2.asignacion_especial_estatus.Pendiente && data.row.estatus_presupuesto_id != ENUM_2.presupuesto_estatus.Completo){
                            return MESSAGE.i('actions.Edit') + ", " +
                                MESSAGE.i('actions.View') + ", " +
                                MESSAGE.i('actions.Remove') + ", " +
                                MESSAGE.i('actions.audit');
                        } if (data.row.poa_estado != ENUM_2.poa_estatus.Cerrado && data.row.estatus_id == ENUM_2.asignacion_especial_estatus.Pendiente){
                            return MESSAGE.i('actions.Edit') + ", " +
                                MESSAGE.i('actions.View') + ", " +
                                MESSAGE.i('actions.audit');
                        }else {
                        ...
                        if (data.row.poa_estado != ENUM_2.poa_estatus.Cerrado && data.row.estatus_id == ENUM_2.asignacion_especial_estatus.Pendiente && data.row.estatus_presupuesto_id != ENUM_2.presupuesto_estatus.Completo){
                            return MESSAGE.i('actions.Edit') + ", " +
                                MESSAGE.i('actions.Remove') + ", " +
                                MESSAGE.i('actions.audit');
                        } else if (data.row.poa_estado != ENUM_2.poa_estatus.Cerrado && data.row.estatus_id == ENUM_2.asignacion_especial_estatus.Pendiente){
                            return MESSAGE.i('actions.Edit') + ", " +
                                MESSAGE.i('actions.audit');
                        } else {
                            return MESSAGE.i('actions.View') + ", " +
