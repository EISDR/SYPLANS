CRUD_vw_dashboard_productosgrid_proceso = {};
DSON.keepmerge(CRUD_vw_dashboard_productosgrid_proceso, CRUDDEFAULTS);
DSON.keepmerge(CRUD_vw_dashboard_productosgrid_proceso, {
    table: {
        engine: 'ms',
        report: true,
        view: 'vw_dashboard_productosgrid_proceso',
