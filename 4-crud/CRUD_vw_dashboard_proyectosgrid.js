CRUD_vw_dashboard_proyectosgrid = {};
DSON.keepmerge(CRUD_vw_dashboard_proyectosgrid, CRUDDEFAULTS);
DSON.keepmerge(CRUD_vw_dashboard_proyectosgrid, {
    table: {
        engine: 'ms',
        report: true,
        view: 'vw_dashboard_proyectosgrid',
        ...
        columns: {
            ...
            detalle: {
                ...
                click: function (data) {
                    console.log(data);
                    vw_dashboard_proyectosgrid.selectedPEI = data.row.id;
                    baseController.modal.modalView("indicador_producto_poa_producto", {
                        header: {
                        ...
                        content: {
                            ...
                            sameController: 'indicador_producto_poa_producto'
                        },
                    });
                }
            }
