CRUD_impacto_politica = {};
DSON.keepmerge(CRUD_impacto_politica, CRUDDEFAULTS);
DSON.keepmerge(CRUD_impacto_politica, {
    table: {
        //width: "width:3000px;",
        view: 'vw_impacto_politica',
        //method: 'impacto_politica',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_impacto_politica.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_impacto_politica.table.options[0].menus.push({
//     text: (data) => {
