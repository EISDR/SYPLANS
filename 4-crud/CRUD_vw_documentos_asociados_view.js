CRUD_vw_documentos_asociados_view = {};
DSON.keepmerge(CRUD_vw_documentos_asociados_view, CRUDDEFAULTS);
DSON.keepmerge(CRUD_vw_documentos_asociados_view, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_vw_documentos_asociados_view',
        //method: 'vw_documentos_asociados_view',
        //limits: [10, 50, 100, 0],
        //report: true,
        piemessage: false,
        batch: false,
        ...
        columns: {
            ...
            proceso_nombre: {
                ...
                rowspan: function (index, list, category) {
                    return (category === "span") ? vw_documentos_asociados_view.sp_('d.proceso_nombre', index, list) : vw_documentos_asociados_view.sm_('d.proceso_nombre', index, list);
                }
            },
            codigo: {
                label: function () {
            ...
            condicion: {
                ...
                format: function (row) {
                    $(`.Incompleto`).css('background', '#FF0000');
                    $(`.Completo`).css('background', '#548235');
                    if (auditoria_programa_plan.validate_documentos_view(row)){
                        return `<div title="Completo" class='Completo shape_element'> </div>`;
                    }else{
...
//CRUD_vw_documentos_asociados_view.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_vw_documentos_asociados_view.table.options[0].menus.push({
//     text: (data) => {
