CRUD_resultado_view = {};
DSON.keepmerge(CRUD_resultado_view, CRUDDEFAULTS);
DSON.keepmerge(CRUD_resultado_view, {
    table: {
        engine: 'my',
        view:"vw_resultado",
        method: "resultado",
        ...
        options: [
            {
                ...
                title: (data) => {
                    if (PERMISSIONS.mypermission.resultado.allow.edit && PERMISSIONS.mypermission.resultado.allow.view && PERMISSIONS.mypermission.resultado.allow.remove){
