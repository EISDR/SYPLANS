CRUD_responsable_tipo = {};
DSON.keepmerge(CRUD_responsable_tipo, CRUDDEFAULTS);
DSON.keepmerge(CRUD_responsable_tipo, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_responsable_tipo',
        //method: 'responsable_tipo',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_responsable_tipo.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_responsable_tipo.table.options[0].menus.push({
//     text: (data) => {
