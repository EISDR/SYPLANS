CRUD_politica_gobierno = {};
DSON.keepmerge(CRUD_politica_gobierno, CRUDDEFAULTS);
DSON.keepmerge(CRUD_politica_gobierno, {
    table: {
        //width: "width:3000px;",
        view: 'vw_politica_gobierno',
        viewReport: 'vw_politica_gobierno_export',
        //method: 'politica_gobierno',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_politica_gobierno.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_politica_gobierno.table.options[0].menus.push({
//     text: (data) => {
