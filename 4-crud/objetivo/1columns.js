CRUD_objetivo = {};
DSON.keepmerge(CRUD_objetivo, CRUDDEFAULTS);
DSON.keepmerge(CRUD_objetivo, {
    table: {
        view: "vw_objetivo_general",
        engine: 'my',
        sort: "id",
        order: "desc",
        columns: {
                ...
                menus: [
                    ...
                    },
                    {
                        ...
                        click: async function (data) {
                            ...
                            var result_objetivo = await BASEAPI.firstp('objetivo_estrategico_oe_end',{
                                where:[{
                                    field: "objetivo",
                                    value: data.row.id
                                }]
                            ...
                            if (result_objetivo){
                                SWEETALERT.show({
                                    message: `<p>Registro está relacionado a la entidad "Objetivo Estratégico".</p> Este no puede ser borrado a menos que se elimine su relación con la entidad.`,
                                });
                            }else {
