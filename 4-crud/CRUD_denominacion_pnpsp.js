CRUD_denominacion_pnpsp = {};
DSON.keepmerge(CRUD_denominacion_pnpsp, CRUDDEFAULTS);
DSON.keepmerge(CRUD_denominacion_pnpsp, {
    table: {
        //width: "width:3000px;",
        view: 'vw_denominacion_pnpsp',
        //method: 'denominacion_pnpsp',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_denominacion_pnpsp.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_denominacion_pnpsp.table.options[0].menus.push({
//     text: (data) => {
