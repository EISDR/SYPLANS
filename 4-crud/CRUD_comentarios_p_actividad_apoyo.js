CRUD_comentarios_p_actividad_apoyo = {};
DSON.keepmerge(CRUD_comentarios_p_actividad_apoyo, CRUDDEFAULTS);
DSON.keepmerge(CRUD_comentarios_p_actividad_apoyo, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_comentarios_actividad_apoyo',
        //method: 'comentarios_actividad_apoyo',
        //limits: [10, 50, 100, 0],
        //report: true,
        batch: false,
        sort: "id",
                ...
                format: function (row) {
                    if (typeof comentarios_p_actividad_apoyo !== 'null') {
                        if (comentarios_p_actividad_apoyo) {
                            var info = comentarios_p_actividad_apoyo.fileSI.filter(data => {
...
//CRUD_comentarios_p_actividad_apoyo.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_comentarios_p_actividad_apoyo.table.options[0].menus.push({
//     text: (data) => {
