CRUD_auditoria_programa_plan_prioridad = {};
DSON.keepmerge(CRUD_auditoria_programa_plan_prioridad, CRUDDEFAULTS);
DSON.keepmerge(CRUD_auditoria_programa_plan_prioridad, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_auditoria_programa_plan_prioridad',
        //method: 'auditoria_programa_plan_prioridad',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_auditoria_programa_plan_prioridad.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_auditoria_programa_plan_prioridad.table.options[0].menus.push({
//     text: (data) => {
