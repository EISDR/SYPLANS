...
var From_where = '';
var Ocurrencia = '';
CRUD_vw_riesgo_proceso = {};
DSON.keepmerge(CRUD_vw_riesgo_proceso, CRUDDEFAULTS);
DSON.keepmerge(CRUD_vw_riesgo_proceso, {
    table: {
        width: "width:2000px;",
        //view: 'vw_riesgo_proceso',
        //method: 'vw_riesgo_proceso',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_vw_riesgo_proceso.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_vw_riesgo_proceso.table.options[0].menus.push({
//     text: (data) => {
