CRUD_vw_comentarios = {};
DSON.keepmerge(CRUD_vw_comentarios, CRUDDEFAULTS);
DSON.keepmerge(CRUD_vw_comentarios, {
    table: {
        //width: "width:3000px;",
        view: 'vw_comentarios',
        //method: 'vw_comentarios',
        //limits: [10, 50, 100, 0],
        //report: true,
        batch: false,
        //persist: false,
                                ...
                                confirm: async function () {
                                    ...
                                    BASEAPI.deleteall('comentarios', [
                                        ...
                                        if (typeof indicador_producto_poa_actividad != "undefined") {
                                            if (indicador_producto_poa_actividad) {
...
//CRUD_vw_comentarios.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_vw_comentarios.table.options[0].menus.push({
//     text: (data) => {
