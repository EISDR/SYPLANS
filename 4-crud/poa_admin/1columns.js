CRUD_poa_admin = {};
DSON.keepmerge(CRUD_poa_admin, CRUDDEFAULTS);
DSON.keepmerge(CRUD_poa_admin, {
    table: {
        engine: 'my',
        view: "vw_poa",
        method:"poa",
        ...
        options: [
            ...
            {
                text: (data) => {
                    return MESSAGE.i('planificacion.titlePoaMantenimiento');
                },
                title: (data) => {
                    return MESSAGE.i('planificacion.titlePoaMantenimiento');
                },
                ...
                show:(data)=>{
                    // if(data.row){
                    //     return ((data.row.id_estado === ENUM_2.poa_estatus.Pendiente_a_autorizar) && (data.row.activo === ENUM_2.poa_estatus.Activo));
                    // }
                    return false;
                },
                characterist: (data) => {
                ...
                click: function (data) {
                    poa_admin.open_modal_mega_opcion();
                    return false;
                }
            },
        ],
