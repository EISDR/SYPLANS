CRUD_direcciones_generales = {};
DSON.keepmerge(CRUD_direcciones_generales, CRUDDEFAULTS);
DSON.keepmerge(CRUD_direcciones_generales, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_direcciones_generales',
        //method: 'direcciones_generales',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
                    ...
                    },
                    {
                        ...
                        click: function (data) {
                            if (!DSON.oseaX(data.row)) {
                                direcciones_generales.dataForView = data.row;
                                direcciones_generales.modal.modalView(String.format("{0}/view", 'direcciones_generales'), {
                                    header: {
                                    ...
                                    content: {
                                        ...
                                        sameController: 'direcciones_generales'
                                    },
                                });
                            }
                        }
...
//CRUD_direcciones_generales.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_direcciones_generales.table.options[0].menus.push({
//     text: (data) => {
