CRUD_vw_razon_apoyo = {};
DSON.keepmerge(CRUD_vw_razon_apoyo, CRUDDEFAULTS);
DSON.keepmerge(CRUD_vw_razon_apoyo, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_vw_razon_apoyo',
        //method: 'vw_razon_apoyo',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_vw_razon_apoyo.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_vw_razon_apoyo.table.options[0].menus.push({
//     text: (data) => {
