CRUD_tipo_riesgo = {};
DSON.keepmerge(CRUD_tipo_riesgo, CRUDDEFAULTS);
DSON.keepmerge(CRUD_tipo_riesgo, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_tipo_riesgo',
        //method: 'tipo_riesgo',
...
//CRUD_tipo_riesgo.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_tipo_riesgo.table.options[0].menus.push({
//     text: (data) => {
