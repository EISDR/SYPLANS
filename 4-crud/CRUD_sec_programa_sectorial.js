CRUD_sec_programa_sectorial = {};
DSON.keepmerge(CRUD_sec_programa_sectorial, CRUDDEFAULTS);
DSON.keepmerge(CRUD_sec_programa_sectorial, {
    table: {
        width: "width:2000px;",
        view: 'vw_sec_programa_sectorial',
        viewReport: 'vw_sec_programa_sectorial_export',
        //method: 'sec_programa_sectorial',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
        ...
        columns: {
            ...
            nombre: {
                label: function (){
                    return "Programa Sectorial"
                }
            },
            descripcion: {shorttext: 360},
            estimacion_presupuestaria: {
                label: function (){
            ...
            supuestos: {
                ...
                format: function (row) {
                    if (row.supuestos){
                        return `<ul><li>${row.supuestos.replaceAll("\n", "</li><li>").replaceAll("\r", "</li><li>")}</li></ul>`
                    }
                }
            },
            fecha_desde: {
            ...
            sector_economico_social: {
                label: function (){
                    return "Sector Económico Social"
                }
            },
            eje_estrategico: {
                export: false,
                exportExample: false,
                label: function (){
                    return "Alineación con Eje Estratégico Institucional"
                }
            },
            ejes_estrategicos: {
                label: function (){
            ...
            involucrado: {
                ...
                exportExample: false,
                label: function (){
                    return "Instituciones Involucradas"
                }
            },
            involucrados: {
                label: function (){
            ...
            responsable: {
                ...
                exportExample: false,
                label: function (){
                    return "Instituciones Responsables"
                }
            },
            responsables: {
                label: function (){
        ...
        filters: {
            columns: [
                ...
                },
                {
                    ...
                    type: FILTER.types.string,
                    placeholder: 'Programa Sectorial'
                },
                {
                    key: 'descripcion',
                    label: 'Descripción',
                ...
                },
                {
                    ...
                    query: {
                        ...
                        where: [
                            {
                                "field": "sector_id",
                                "value": new SESSION().current() ? new SESSION().current().sector_id : -1
                            },
                        ],
                        orderby: "id",
                        order: "asc",
                ...
                {
                    key: 'objetivo_sectorial',
                    label: 'Objetivo Sectorial',
                    type: FILTER.types.relation,
                    table: 'vw_sec_objetivo_sectorial',
                    value: "id",
                    text: "item.sec_nombre",
                    query: {
                        limit: 0,
                ...
                {
                    key: 'resultado_sectorial',
                    label: 'Resultado Sectorial',
                    type: FILTER.types.relation,
                    table: 'vw_sec_resultado_sectorial',
                    value: "id",
                    text: "item.sec_nombre",
                    query: {
                        limit: 0,
                ...
                },
                {
                    ...
                    label: 'Estatus',
                    type: FILTER.types.relation,
                    table: 'sec_programa_sectorial_estatus',
                    value: "id",
                    text: "item.nombre",
                    query: {
                        limit: 0,
...
//CRUD_sec_programa_sectorial.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_sec_programa_sectorial.table.options[0].menus.push({
//     text: (data) => {
