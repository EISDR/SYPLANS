CRUD_razon = {};
DSON.keepmerge(CRUD_razon, CRUDDEFAULTS);
DSON.keepmerge(CRUD_razon, {
    table: {
        //width: "width:3000px;",
        view: 'vw_razon',
        //method: 'razon',
...
//CRUD_razon.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_razon.table.options[0].menus.push({
//     text: (data) => {
