...
CRUD_indicador_generico = {};
DSON.keepmerge(CRUD_indicador_generico, CRUDDEFAULTS);
DSON.keepmerge(CRUD_indicador_generico, {
    table: {
        engine: 'my',
        ...
        options: [
                ...
                menus: [
                    {
                        ...
                        click: function (data) {
                            ...
                            data.$scope.poa_monitoreo_old_audit = data.row.poa_monitoreo_nombre;
                            data.$scope.oldData_forAudit = data.row;
            ...
            },
            {
                ...
                click: function (data) {
                    ...
                    //     });
                    // }
                    indicador_generico.list_indicador_generico_periodo_view = [];
                    indicador_generico.detalleapd = [];
                    var contador = 1;
                    BASEAPI.listp('vw_indicador_generico_periodo', {
                        limit: 0,
                        ...
                        indicador_generico.list_indicador_generico_periodo_view = result.data;
                        for (var key of indicador_generico.list_indicador_generico_periodo) {
                            indicador_generico.detalleapd.push({
                                column: 'Proyectado ' + periodo + ' ' + contador,
                                row: key.valor
