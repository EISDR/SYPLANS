CRUD_comentarios_actividades_poa = {};
DSON.keepmerge(CRUD_comentarios_actividades_poa, CRUDDEFAULTS);
DSON.keepmerge(CRUD_comentarios_actividades_poa, {
    table: {
        engine: 'my',
        // view: 'comentarios',
        // method: 'comentarios',
                ...
                format: function (row) {
                    if (typeof comentarios_actividades_poa !== 'null') {
                        if (comentarios_actividades_poa) {
                            var info = comentarios_actividades_poa.fileSI.filter(data => {
