CRUD_sec_eje_sectorial = {};
DSON.keepmerge(CRUD_sec_eje_sectorial, CRUDDEFAULTS);
DSON.keepmerge(CRUD_sec_eje_sectorial, {
    table: {
        //width: "width:3000px;",
        view: 'vw_sec_eje_sectorial',
        //method: 'sec_eje_sectorial',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_sec_eje_sectorial.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_sec_eje_sectorial.table.options[0].menus.push({
//     text: (data) => {
