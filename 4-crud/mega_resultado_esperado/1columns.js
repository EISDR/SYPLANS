CRUD_mega_resultado_esperado = {};
DSON.keepmerge(CRUD_mega_resultado_esperado, CRUDDEFAULTS);
DSON.keepmerge(CRUD_mega_resultado_esperado, {
    table: {
        engine: 'my',
        width: "width: 2200px;",
        view:"vw_mega_resultado_esperado",
        method: "resultado",
        sort: "id",
        order: "desc",
        batch:true,
        columns: {
            ...
            },
            {
                ...
                click: function (data) {
                    mega_resultado_esperado.openmodalField(data.row.id,data.row.resultado_nombre);
                    return false;
                },
