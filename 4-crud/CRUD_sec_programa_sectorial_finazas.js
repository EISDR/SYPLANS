CRUD_sec_programa_sectorial_finazas = {};
DSON.keepmerge(CRUD_sec_programa_sectorial_finazas, CRUDDEFAULTS);
DSON.keepmerge(CRUD_sec_programa_sectorial_finazas, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_sec_programa_sectorial_finazas',
        //method: 'sec_programa_sectorial_finazas',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
        ...
        columns: {
            ...
            ano: {
                ...
                formattype: ENUM.FORMAT.string
            },
            valor: {formattype: ENUM.FORMAT.decimal}
        },
        filters: {
            columns: true
        },
...
//CRUD_sec_programa_sectorial_finazas.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_sec_programa_sectorial_finazas.table.options[0].menus.push({
//     text: (data) => {
