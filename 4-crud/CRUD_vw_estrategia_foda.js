CRUD_vw_estrategia_foda = {};
DSON.keepmerge(CRUD_vw_estrategia_foda, CRUDDEFAULTS);
DSON.keepmerge(CRUD_vw_estrategia_foda, {
    table: {
        width: "width: 1500px;",
        view: 'vw_estrategia',
        //method: 'vw_estrategia_foda',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_vw_estrategia_foda.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_vw_estrategia_foda.table.options[0].menus.push({
//     text: (data) => {
