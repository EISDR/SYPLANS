CRUD_sec_objetivo_sectorial = {};
DSON.keepmerge(CRUD_sec_objetivo_sectorial, CRUDDEFAULTS);
DSON.keepmerge(CRUD_sec_objetivo_sectorial, {
    table: {
        //width: "width:3000px;",
        view: 'vw_sec_objetivo_sectorial',
        //method: 'sec_objetivo_sectorial',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_sec_objetivo_sectorial.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_sec_objetivo_sectorial.table.options[0].menus.push({
//     text: (data) => {
