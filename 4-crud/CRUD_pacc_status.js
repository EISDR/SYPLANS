CRUD_pacc_status = {};
DSON.keepmerge(CRUD_pacc_status, CRUDDEFAULTS);
DSON.keepmerge(CRUD_pacc_status, {
    table: {
        width: "width:1550px;",
        //view: 'vw_pacc_status',
        //method: 'pacc_status',
        ...
        columns: {
            ...
            before_descripcion_larga: {
                shorttext: 360,
                label: function () {
                    return "Descripción Larga Anterior"
                }
            },
            next_descripcion: {
                label: function () {
            ...
            next_descripcion_larga: {
                shorttext: 360,
                label: function () {
                    return "Descripción Larga Siguiente"
                }
            },
            active: {formattype: ENUM.FORMAT.bool},
            color: {
                sortable: false,
                label: function() {
...
//CRUD_pacc_status.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_pacc_status.table.options[0].menus.push({
//     text: (data) => {
