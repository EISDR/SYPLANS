CRUD_involucrados = {};
DSON.keepmerge(CRUD_involucrados, CRUDDEFAULTS);
DSON.keepmerge(CRUD_involucrados, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_involucrados',
        //method: 'involucrados',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        ...
        columns: {
            ...
            involucrados_tipo_nombre: {
                ...
                exportKey: 'tipo',
                exportExample: "1-Productos, " +
                    "2-Resultado Sectorial, " +
...
//CRUD_involucrados.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_involucrados.table.options[0].menus.push({
//     text: (data) => {
