CRUD_fuente_financiamiento = {};
DSON.keepmerge(CRUD_fuente_financiamiento, CRUDDEFAULTS);
DSON.keepmerge(CRUD_fuente_financiamiento, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_fuente_financiamiento',
        //method: 'fuente_financiamiento',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_fuente_financiamiento.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_fuente_financiamiento.table.options[0].menus.push({
//     text: (data) => {
