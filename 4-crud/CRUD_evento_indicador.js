CRUD_evento_indicador = {};
DSON.keepmerge(CRUD_evento_indicador, CRUDDEFAULTS);
DSON.keepmerge(CRUD_evento_indicador, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_evento_indicador',
        //method: 'evento_indicador',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_evento_indicador.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_evento_indicador.table.options[0].menus.push({
//     text: (data) => {
