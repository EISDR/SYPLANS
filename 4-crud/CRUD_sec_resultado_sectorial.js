CRUD_sec_resultado_sectorial = {};
DSON.keepmerge(CRUD_sec_resultado_sectorial, CRUDDEFAULTS);
DSON.keepmerge(CRUD_sec_resultado_sectorial, {
    table: {
        width: "width:1850px;",
        view: 'vw_sec_resultado_sectorial',
        viewExport: 'vw_sec_resultado_sectorial_export',
        //method: 'sec_resultado_sectorial',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
        ...
        filters: {
            columns: [
                ...
                {
                    key: 'sector_economico_social',
                    label: 'Sector Económico Social',
                    type: FILTER.types.string,
                    placeholder: 'Sector Económico Social'
                },
                {
                    key: 'eje_sectorial',
                    label: 'Eje Sectorial',
                ...
                },
                {
                    ...
                    label: 'Estatus',
                    type: FILTER.types.relation,
                    table: 'sec_resultado_sectorial_estatus',
                    value: "id",
                    text: "item.nombre",
                    query: {
                        limit: 0,
...
//CRUD_sec_resultado_sectorial.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_sec_resultado_sectorial.table.options[0].menus.push({
//     text: (data) => {
