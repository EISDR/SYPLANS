CRUD_supuestos = {};
DSON.keepmerge(CRUD_supuestos, CRUDDEFAULTS);
DSON.keepmerge(CRUD_supuestos, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_supuestos',
        //method: 'supuestos',
...
//CRUD_supuestos.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_supuestos.table.options[0].menus.push({
//     text: (data) => {
