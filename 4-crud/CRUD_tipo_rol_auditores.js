CRUD_tipo_rol_auditores = {};
DSON.keepmerge(CRUD_tipo_rol_auditores, CRUDDEFAULTS);
DSON.keepmerge(CRUD_tipo_rol_auditores, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_tipo_rol_auditores',
        //method: 'tipo_rol_auditores',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
...
//CRUD_tipo_rol_auditores.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_tipo_rol_auditores.table.options[0].menus.push({
//     text: (data) => {
