CRUD_comentarios_p_actividad = {};
DSON.keepmerge(CRUD_comentarios_p_actividad, CRUDDEFAULTS);
DSON.keepmerge(CRUD_comentarios_p_actividad, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_comentarios_p_actividad',
        //method: 'comentarios_p_actividad',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
        ...
        columns: {
            ...
            estatus_actividad_apoyo: {
                label: function(){
                    return "Estatus de la Actividad"
                }
            },
            archivos: {
                label: "Archivos",
                format: function (row) {
                    if (typeof comentarios_p_actividad !== 'null') {
                        if (comentarios_p_actividad) {
                            var info = comentarios_p_actividad.fileSI.filter(data => {
...
//CRUD_comentarios_p_actividad.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_comentarios_p_actividad.table.options[0].menus.push({
//     text: (data) => {
