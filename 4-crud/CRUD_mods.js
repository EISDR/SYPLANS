CRUD_mods = {};
DSON.keepmerge(CRUD_mods, CRUDDEFAULTS);
DSON.keepmerge(CRUD_mods, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_mods',
        //method: 'mods',
                ...
                menus: [
                    ...
                    },
                    {
                        ...
                        click: async function (data) {
                            var result_resultado = await BASEAPI.firstp('resultado_mods',{
                                where:[{
                                    field: "mods",
                                    value: data.row.id
                                }]
...
//CRUD_mods.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_mods.table.options[0].menus.push({
//     text: (data) => {
