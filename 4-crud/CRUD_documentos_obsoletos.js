CRUD_documentos_obsoletos = {};
DSON.keepmerge(CRUD_documentos_obsoletos, CRUDDEFAULTS);
DSON.keepmerge(CRUD_documentos_obsoletos, {
    table: {
        width: "width:2000px;",
        view: 'vw_documentos_asociados_mp',
        //method: 'documentos_obsoletos',
        //report: true,
        batch: false,
        //persist: false,
        //sortable: false,
...
//CRUD_documentos_obsoletos.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_documentos_obsoletos.table.options[0].menus.push({
//     text: (data) => {
