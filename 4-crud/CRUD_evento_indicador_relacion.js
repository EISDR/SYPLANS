CRUD_evento_indicador_relacion = {};
DSON.keepmerge(CRUD_evento_indicador_relacion, CRUDDEFAULTS);
DSON.keepmerge(CRUD_evento_indicador_relacion, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_evento_indicador_relacion',
        //method: 'evento_indicador_relacion',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        //persist: false,
        ...
        columns: {
            ...
            evento_indicador_urgencia_nombre: {
                label: function () {
                    return "Urgencia"
                }
            },
        ...
        single: [
            {
                "table": "evento_indicador_urgencia",
                "base": "urgencia",
                "field": "id",
                "columns": ["id", "nombre"]
            },
            {
                'table': 'evento_indicador',
                'base': 'evento_indicador',
                'field': 'id',
                'columns': ['id', 'nombre']
            }
        ],
...
//CRUD_evento_indicador_relacion.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_evento_indicador_relacion.table.options[0].menus.push({
//     text: (data) => {
