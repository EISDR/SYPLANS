CRUD_trabajar_actividades_poa_monitoreo = {};
DSON.keepmerge(CRUD_trabajar_actividades_poa_monitoreo, CRUDDEFAULTS);
DSON.keepmerge(CRUD_trabajar_actividades_poa_monitoreo, {
    table: {
        engine: 'my',
        width: 'width:2000px;',
