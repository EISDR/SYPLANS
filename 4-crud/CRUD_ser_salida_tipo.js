CRUD_ser_salida_tipo = {};
DSON.keepmerge(CRUD_ser_salida_tipo, CRUDDEFAULTS);
DSON.keepmerge(CRUD_ser_salida_tipo, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_ser_salida_tipo',
        //method: 'ser_salida_tipo',
        //limits: [10, 50, 100, 0],
        //report: true,
        batch: false,
        //persist: false,
        ...
        columns: {
            ...
            nececita_fecha_solucion: {
                label: () => {
                    return "Necesita Fecha de Solución?";
                }, visible: true, sorttype: ENUM.FORMAT.bool, formattype: ENUM.FORMAT.bool
            }
        },
        filters: {
            columns: true
...
//CRUD_ser_salida_tipo.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_ser_salida_tipo.table.options[0].menus.push({
//     text: (data) => {
