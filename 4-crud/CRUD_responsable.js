CRUD_responsable = {};
DSON.keepmerge(CRUD_responsable, CRUDDEFAULTS);
DSON.keepmerge(CRUD_responsable, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_responsable',
        //method: 'responsable',
        ...
        columns: {
            ...
            responsable_tipo_nombre: {
                exportKey: 'tipo',
                exportExample: "1-Producto, " +
                    "2-Externo, " +
                    "3-Productos POA",
                label: "Tipo"
            },
...
//CRUD_responsable.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_responsable.table.options[0].menus.push({
//     text: (data) => {
