CRUD_marco_estrategico_valores = {};
DSON.keepmerge(CRUD_marco_estrategico_valores, CRUDDEFAULTS);
DSON.keepmerge(CRUD_marco_estrategico_valores, {
    table: {
        engine: 'my',
        view: 'vw_marco_estrategico_valores',
        sort: "id",
        order: "desc",
        columns: {
            id: {
            ...
            marco_estrategico: {
                ...
                export: false,
                exportExample: false,
                exportfix: "marco_estrategico_valores.id_marco",
                dead: true
            }
        },
        allow: {
