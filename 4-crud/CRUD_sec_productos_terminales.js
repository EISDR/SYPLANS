CRUD_sec_productos_terminales = {};
DSON.keepmerge(CRUD_sec_productos_terminales, CRUDDEFAULTS);
DSON.keepmerge(CRUD_sec_productos_terminales, {
    table: {
        width: "width:3000px;",
        view: 'vw_sec_productos_terminales',
        //method: 'sec_productos_terminales',
        //limits: [10, 50, 100, 0],
        //report: true,
        //batch: false,
        persist: false,
        ...
        filters: {
            columns: [
                ...
                {
                    key: 'proyecto_sectorial',
                    label: 'Proyecto Sectorial',
                    type: FILTER.types.relation,
                    table: 'vw_sec_proyecto_sectorial',
                    value: "id",
                    text: "item.sec_nombre",
                    query: {
                        limit: 0,
                ...
                },
                {
                    ...
                    label: 'Estatus',
                    type: FILTER.types.relation,
                    table: 'sec_proyecto_sectorial_estatus',
                    value: "id",
                    text: "item.nombre",
                    query: {
                        limit: 0,
...
//CRUD_sec_productos_terminales.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_sec_productos_terminales.table.options[0].menus.push({
//     text: (data) => {
