app.controller("actividades_poa", function ($scope, $http, $compile) {
    ...
    actividades_poa.show_diagram = true;
    ...
    actividades_poa.downloadDiagram = () => {
        let image = actividades_poa.myDiagram.makeImage({
            scale: 1
        });
    ...
    actividades_poa.diagram = () => {
        actividades_poa.modal.modalView("actividades_poa/diagram", {
            width: 'modal-full',
            header: {
            ...
            event: {
                show: {
                        ...
                        actividades_poa.statusList = await BASEAPI.listp('vw_modulo_estatus', {
                            limit: 0,
                            orderby: "entidad",
                            order: "asc",
                            where: [
                        ...
                        actividades_poa.statusList = actividades_poa.statusList.data;
                        setTimeout(async function () {
                            const $$$ = go.GraphObject.make;
                            let statusList = actividades_poa.statusList;
                            let thejson = {
                            ...
                            actividades_poa.myDiagram = new go.Diagram(
                            ...
                            actividades_poa.myDiagram.div.style.backgroundColor = colors.background;
                            actividades_poa.myDiagram.nodeTemplate = new go.Node('Auto', {
                                isShadowed: true,
                                shadowBlur: 0,
                            ...
                            actividades_poa.myDiagram.linkTemplate = new go.Link(
                                {
                                    isShadowed: true,
                                    shadowBlur: 0,
                                    shadowColor: 'black',
                            ...
                            actividades_poa.myDiagram.model = go.Model.fromJson(JSON.stringify(thejson));
                            SWEETALERT.stop();
                        }, 1000)
                    }
                }
