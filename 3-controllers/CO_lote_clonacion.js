...
//NNNNNNNNN.irAtras("productos")
        ...
        lote_clonacion.emigrar_poa = async function () {
            ...
            lote_clonacion.prespuesto_aprobado = await BASEAPI.listp("presupuesto_aprobado", {limit: 0, where: [{field: "poa", value: lote_clonacion.session.poa_id}, {field: "departamento", value: lote_clonacion.departamento}]});
