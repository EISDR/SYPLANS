app.controller("auditoria_programa_plan", function ($scope, $http, $compile) {
    ready = async () => {
        ...
        auditoria_programa_plan.getloto = (key, arraykey, field) => {
            return {data: auditoria_programa[`neta${key}`].filter(d => (auditoria_programa_plan[arraykey] || []).indexOf(d[field || "id"] + "") !== -1)};
        }
        ...
        auditoria_programa_plan.formulary = function (data, mode, defaultData, view) {
            auditoria_programa_plan.tepuesdesver = true;
            ...
            if (auditoria_programa_plan !== undefined) {
                ...
                auditoria_programa_plan.createForm(data, mode, defaultData, view || "formperformance", () => {

                    if (auditoria_programa_plan.session.institucion) {
                        auditoria_programa_plan.selectQueries["auditoria_plan_responsable"] = [
                            {
                                field: "compania",
                                operator: "=",
                                value: auditoria_programa_plan.session.compania_id
                            ...
                            {
                                field: "institucion",
                                value: auditoria_programa_plan.session.institucion_id
                            },
                            {
                                field: "active",
                                operator: "=",
                        ...
                        auditoria_programa_plan.selectQueries["auditoria_relacionada"] = [
                            {
                                open: "(",
                                field: "compania",
                                operator: "=",
                        ...
                        auditoria_programa_plan.selectQueries['tipo_auditoria'] = [
                            {
                                field: 'compania',
                                operator: '=',
                                value: auditoria_programa_plan.session.compania_id
                        ...
                        auditoria_programa_plan.selectQueries['prioridad'] = [
                            {
                                field: 'compania',
                                operator: '=',
                                value: auditoria_programa_plan.session.compania_id
                        ...
                        auditoria_programa_plan.selectQueries['auditoria_plan_departamento'] = [
                            {
                                field: 'compania',
                                operator: '=',
                                value: auditoria_programa_plan.session.compania_id
...
select * from vw_auditoria_programa_plan where id=@auditorianext;`;
                ...
                $scope.$watch("auditoria_programa_plan.auditoria_plan_responsable", async function (value) {
                    ...
                    if (auditoria_programa_plan.auditoria_plan_responsable) {
                        if (auditoria_programa_plan.auditoria_plan_responsable.length > 0) {
                            ...
                            auditoria_programa_plan.participantes_list = auditoria_programa_plan.getloto("usuarios", "auditoria_plan_responsable");
                        } else {
                ...
                $scope.$watch("auditoria_programa_plan.auditoria_plan_participantes", async function (value) {
                    ...
                    if (auditoria_programa_plan.auditoria_plan_participantes) {
                        if (auditoria_programa_plan.auditoria_plan_participantes.length > 0) {
                            ...
                            auditoria_programa_plan.real_participantes_list = auditoria_programa_plan.getloto("cargos", "auditoria_plan_participantes");
                        } else {
                ...
                $scope.$watch("auditoria_programa_plan.auditoria_plan_proceso", async function (value) {
                    ...
                    if (auditoria_programa_plan.auditoria_plan_proceso) {
                        if (auditoria_programa_plan.auditoria_plan_proceso.length > 0) {
                            auditoria_programa_plan.procesos_list = auditoria_programa_plan.getloto("procesos", "auditoria_plan_proceso");
                ...
                auditoria_programa_plan.triggers.table.after.control = async function (data) {
                    ...
                    if (data === 'auditoria_plan_departamento') {
                        if (auditoria_programa_plan.auditoria_plan_departamento) {
                            if (auditoria_programa_plan.auditoria_plan_departamento.length > 0) {
                                auditoria_programa_plan.departamento_list = auditoria_programa_plan.getloto("departamentos", "auditoria_plan_departamento");
                                auditoria_programa_plan.form.loadDropDown('auditoria_plan_participantes');
                            } else {
        ...
        auditoria_programa_plan.triggers.table.before.load = () => new Promise(async (resolve, reject) => {
            //console.log(`$scope.triggers.table.before.load ${$scope.modelName}`);
            auditoria_programa_plan.statusList = await BASEAPI.listp('vw_modulo_estatus', {
                limit: 0,
                orderby: "entidad",
                order: "asc",
                where: [
            ...
            auditoria_programa_plan.statusList = auditoria_programa_plan.statusList.data;
            resolve(true);
        });
        auditoria_programa_plan.downloadDiagram = () => {
            let image = auditoria_programa_plan.myDiagram.makeImage({
                scale: 1
            });
            var a = document.createElement("a"); //Create <a>
            a.href = image.src; //Image Base64 Goes here
            a.download = "Flujo de Trabajo - Planes de Auditoría.png";
            a.click();
        };
        auditoria_programa_plan.diagram = () => {
            auditoria_programa_plan.modal.modalView("auditoria_programa_plan/diagram", {
                width: 'modal-full',
                header: {
                ...
                event: {
                    show: {
                            ...
                            setTimeout(async function () {
                                ...
                                let statusList = auditoria_programa_plan.statusList;
                                let thejson = {
                                ...
                                auditoria_programa_plan.myDiagram = new go.Diagram(
                                ...
                                auditoria_programa_plan.myDiagram.div.style.backgroundColor = colors.background;
                                auditoria_programa_plan.myDiagram.nodeTemplate = new go.Node('Auto', {
                                    isShadowed: true,
                                    shadowBlur: 0,
                                ...
                                auditoria_programa_plan.myDiagram.linkTemplate = new go.Link(
                                    {
                                        isShadowed: true,
                                        shadowBlur: 0,
                                        shadowColor: 'black',
                                ...
                                auditoria_programa_plan.myDiagram.model = go.Model.fromJson(JSON.stringify(thejson));
                                SWEETALERT.stop();
                            }, 1000)
                        }
                    }
        ...
        auditoria_programa_plan.getRol = async function () {
            ...
            if (auditoria_programa_plan.auditores) {
                ...
                if (auditoria_programa_plan.auditoria_plan_responsable) {
                    if (auditoria_programa_plan.auditoria_plan_responsable.length > 0) {
                        if (auditoria_programa_plan.auditoria_plan_responsable.filter) {
...
Gracias`;
        ...
        RUNTABLE('auditoria_programa_plan');
        auditoria_programa_plan.refreshAngular();
    }
    ready();
});