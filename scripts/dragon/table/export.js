                            ...
                            $scope.export.json(parameters, type, function (data) {
                                ...
                                if (type === "PDF") {
                                    ...
                                    $scope.modal.simpleModal(`<div style="overflow: auto;height: auto;width: 100%">
                                                                        <div id="info-box" class="alert alert-info alert-styled-left alert-bordered" style="display: ${$scope.show_export_tab ? 'block' : 'none'}; margin-bottom: 5px; padding: 5px 20px;">
